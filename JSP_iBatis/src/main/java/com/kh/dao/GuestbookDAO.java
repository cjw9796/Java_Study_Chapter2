...
//	insert sql 명열을 실행하는 메소드
	...
	public ArrayList<GuestbookVO> selectList(SqlMapClient mapper
											,HashMap<String, Integer> hamp)
											throws SQLException
	{
	...
	public GuestbookVO selectByIdx(SqlMapClient mapper,int idx) 
													throws SQLException{
	...
	// 검색어와 카테고리가 저장된 param을 넘겨받고 guestbook.xml에서 파일의 카테고리
	// 별로 1페이지 분량의 글 목록을 얻어오는 select sql 명령을 실행하는 메서드 
