...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- 이번 문제들은 모두 세션에 학번이 없으면 아예 실행 안하고 바로 00_login.jsp로 이동  -->    
<%
...
<!-- 
	...
	//학년을 선택했을때 여러개가 저장될 수도 있고 하나만 or 아예 없을 수도 있다.
	//저장하는 자료형은?
	
	//학년과 전공을 꺼내서 getGradeMajorSubject(grade,major);
	//SubjectDAO에서 매개변수를 만족하는 값만 리턴받아서 온다. 
-->
...
<head>
<meta charset="UTF-8">
<title>08_subjectSelect.jsp</title>
</head>
<body>

<div align="right" style="border:1px solid">
	<form action="01_Main.jsp?center=08_subjeectSelect.jsp" method="post">
