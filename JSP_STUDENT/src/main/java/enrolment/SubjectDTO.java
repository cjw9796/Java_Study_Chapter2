...
public class SubjectDTO {
	...
	public String toString() {
		return " [subjectNum=" + subjectNum + ", subjectName=" + subjectName + ", professorName=" + professorName
				+ ", hakjom=" + hakjom + ", major=" + major + ", room=" + room + ", subjectPurpos=" + subjectPurpos
				+ ", subjectGoal=" + subjectGoal + ", subjectTest=" + subjectTest + ", grade=" + grade
