...
<% 
	...
	}else{  // 로그인이 되어서 관리자 확인이 되면 관리자 페이지를 확인 
...
<head>
<meta charset="UTF-8">
<title>10_bookList.jsp 상품 등록 결과 화면</title>
</head>
<body>

	<!--  관리자 전용 페이지 상품을 등록하면 분류에 따라서 등록한 분류목록을 
		보여준다. 
		만약 관리자가 아닐 경우에는 shopMain.jsp
		
		현재 추가한 분류목록을 가지고 책들을 리스트업한다. 
		현재 추가한 분류목록의 책의 정보들을 전부 가지고 올것인지 
		현재 전체 조회가 아니라면 각각 분류목록의 count를 해야된다.
