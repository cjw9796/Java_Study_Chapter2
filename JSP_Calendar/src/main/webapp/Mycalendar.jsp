...
<body>
	...
	/*
		 Calendar 클래스
		 날짜와 시간을 객체 저장하는 클래스 
		 추상클래스로 되어있어서 객체를 생성을 할 수 없다. 
		 현재 사용자의 현재 시스템 시간 정보를 얻어 올 때 
		 getInstance() 라는 정적(Static) 메서드를 이용하면 객체를 생성을 할 수 있다. 
	*/	
		...
		//get()
		// 캘린더 인스턴스에서 저장된 정보 중 상수를 전달하여 원하는 값을 반환하는 메서드 
		
		//set()
		// 캘린더 인스턴스에서 저장된 시간, 날짜를 수정, 변경하는 메서드
